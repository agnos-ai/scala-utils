...
object StringExtensions {
  ...
  implicit class ExtendedString1(charSequence : CharSequence) {

    /**
     * Strips all whitespace before a line that starts with the pipe symbol:
     *
     * val query = s"""
     *     |SELECT *
     *     |WHERE blabla
     ...
     * "
     */
    def stripped : String = strippedRegex.replaceAllIn(charSequence, "\n")
  }
